...
/**
 * Parses YAML configuration content into a flat key-value map.
 *
 * <p>Nested structures are flattened using dot-separated paths
 * and bracket-index notation:
 * <pre>{@code
 * beehive:
 *   executor-properties:
 *     - core-pool-size: 10
 * }
 * → {@code beehive.executor-properties[0].core-pool-size} → {@code "10"}
 * </pre>
 *
 * @author cnan
 */
